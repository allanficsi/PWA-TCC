...
% ----------------------------------------------------------
\include{capitulos/cap1}%introdução
\include{capitulos/cap2}%arquiteturas web
\include{capitulos/cap3}%Arquitetura do MOBILE
\include{capitulos/cap4}%Introdução ao PWA
\include{capitulos/cap5}%Estudo Comparativo (Tabela evidenciando a diferença MOBILE x WEB x PWA)
\include{capitulos/cap6}%Estudo de Caso
\include{capitulos/cap7}% Conclusao
% ----------------------------------------------------------
% PARTE I
% ----------------------------------------------------------
